...
(function () {
  var META = {
    "model-plan.html": {
      zh: { h1: "🧠 AI 模型选型横评", sub: "9 款 AI 旗舰模型技术特性 × 适用场景映射，架构假设深度解析，帮你精准匹配最优模型。" },
      en: { h1: "🧠 AI Model Selection Guide", sub: "Nine flagship models — capabilities, architecture, and scenario mapping to pick the best fit." },
    },
    "hardware-plan.html": {
    ...
    "ai-factory-plan.html": {
      zh: { h1: "🏭 AI 造物 · 从创意到商品", sub: "AI 造物流水线：设计 → 打样 → 上架，工具链与成本一览。" },
      en: { h1: "🏭 AI Product Pipeline", sub: "From idea to shelf — design, prototype, and listing tools in one workflow." },
    },
    "skill-plan.html": {
